...
docker exec -ti streamworks_kafka_broker bin/kafka-topics.sh --create --zookeeper $zk_host_port --replication-factor $replication_factor --partitions $partitions --topic $topic
